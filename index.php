  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">evansrotichh@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+254705330676</span></i>
      </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+254705330676">+254705330676</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">Evansrotichh7@gmail</a></p>
            </div>
          </div>
